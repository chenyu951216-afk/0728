...
def _import_production_blocking_joint() -> tuple[Any, Any]:
    ...
    # Install every research/live safety authority before V26 captures the heavy
    # certification function into its single background executor.
    ...
    production.core.state['bootstrap_replica_role'] = {
        ...
        'research_runtime': 'V36_AUTONOMOUS_DIRECT_R_FIXED_20260801',
        ...
        'bitget_max_leverage_truth': True,
