...
try:
    import server_v18 as production
    app = production.app
    ...
    app = FastAPI(title='ETH Adaptive AI bootstrap fail-closed', version='9.0.0-bootstrap')
