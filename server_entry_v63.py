...
"""Production entry for V63 capped-score current-paper authority."""
...
LOG = logging.getLogger('eth-adaptive.v63-entry')
v27 = v60_entry.v27
_ORIGINAL_V60_IMPORT = v27.base._import_production_blocking


def _import_production_blocking_v63():
    ...
    # Important: V63 configures V62/V61 before their provisional worker starts, so the
    # score policy is authoritative from the first terminal-OOS handoff.
    ...
    if isinstance(role, dict):
        role.update({
            'final_runtime_overlay': 'V63_CAPPED_SCORE_ARBITER_DISCORD_LIFECYCLE',
            'production_entry': 'server_entry_v63.py',
            ...
            'provisional_paper_authority': 'V63_CAPPED_SCORE_ARBITER_DISCORD_LIFECYCLE',
            'score_authority': 'V63_CAPPED_SCORE_ARBITER_DISCORD_LIFECYCLE',
        })
    return production, app


v27.base._import_production_blocking = _import_production_blocking_v63
app = v27.base.app

if __name__ == '__main__':
    LOG.info('UVICORN_BIND host=0.0.0.0 port=%s mode=AUTONOMOUS_V36 overlay=V54_TERMINAL_RUNTIME', v27.base.PORT)
    LOG.info('UVICORN_BIND host=0.0.0.0 port=%s final_overlay=V63_CAPPED_SCORE_ARBITER_DISCORD_LIFECYCLE', v27.base.PORT)
    LOG.info('STACK research=V56 live_hooks=V57 api_cache=V58 dashboard=V59 diagnostics=V60 score_arbiter=V63')
