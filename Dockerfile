...
COPY app.py adaptive_engine.py adaptive_v5.py execution_v6.py execution_v7.py market_data.py derivative_data.py server.py server_v17.py server_v18.py server_entry.py ./
COPY v*.py ./
COPY dashboard*.html ./
