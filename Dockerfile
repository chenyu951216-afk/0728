...
COPY app.py adaptive_engine.py adaptive_v5.py execution_v6.py execution_v7.py market_data.py derivative_data.py runtime_identity.py server.py server_v17.py server_v18.py server_v19.py server_entry.py server_entry_v27.py server_entry_v48.py server_entry_v49.py server_entry_v50.py server_entry_v51.py server_entry_v52.py server_entry_v53.py server_entry_v54.py server_entry_v55.py server_entry_v56.py server_entry_v57.py server_entry_v58.py server_entry_v59.py server_entry_v60.py server_entry_v61.py server_entry_v62.py server_entry_v63.py server_entry_v64.py server_entry_v65.py server_entry_v66.py server_entry_v67.py ./
COPY v*.py ./
COPY dashboard*.html ./
...
USER scanner
EXPOSE 8080
CMD ["python", "-u", "server_entry_v67.py"]
